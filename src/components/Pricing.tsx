      ...
      <div className="p-4 bg-[#1e293b] text-white rounded-lg max-w-4xl mx-auto">
        ...
        <div className="overflow-x-auto border border-[#2f3745] rounded-xl">
          <table className="w-full text-left border-collapse rounded-xl">
            ...
            <tbody>
              <tr>
                <td className="px-4 py-3 border-t border-gray-700">OpenAI</td>
                <td className="px-4 py-3 border-t border-gray-700">GPT-3.5</td>
                <td className="px-4 py-3 border-t border-gray-700">$0.002</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-t border-gray-700">OpenAI</td>
                <td className="px-4 py-3 border-t border-gray-700">GPT-4</td>
                <td className="px-4 py-3 border-t border-gray-700">$0.03</td>
              </tr>
              <tr>
                ...
                <td className="px-4 py-3 border-t border-gray-700">$0.0008</td>
              </tr>
              <tr>
                <td className="px-4 py-3 border-t border-gray-700">
                  Together AI
                ...
                <td className="px-4 py-3 border-t border-gray-700">$0.0006</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-[#A2AEFC]">Token Estimation</h3>
          <p className="mt-2">
        ...
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-[#A2AEFC]">Billing</h3>
          <p className="mt-2">
